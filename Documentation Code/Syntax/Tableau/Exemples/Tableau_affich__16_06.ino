...
void loop() {
//Affichage d'une donnée hors de la limite du tableau un.
Serial.print("La donnee hors limite du tableau un vaut "); //Message complémentiare
Serial.print(tab_1[16]); //Affichage de la donnée.
