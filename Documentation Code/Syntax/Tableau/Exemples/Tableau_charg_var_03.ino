...
void loop() {
//Charger une donnée du tableau un dans une variable
int var; //Décalration de la variable utile.
var = tab_1[7]; //Chargement de la huitième donnée du tableau dans la variable.
Serial.print("La variable var vaut "); //Message complémentiare
Serial.print(var); //Affichage du resultat.
