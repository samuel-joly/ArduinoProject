...
void loop() {
//Affichage de la cinquième donnée du tableau un.
Serial.print("La cinquieme donnee du tableau un vaut "); //Message complémentiare
Serial.print(tab_1[4]); //Affichage de la donnée à l'indice quatre. 
