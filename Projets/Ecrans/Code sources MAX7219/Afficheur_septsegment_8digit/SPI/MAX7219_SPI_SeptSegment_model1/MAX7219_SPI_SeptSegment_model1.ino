 ...
 *********************** AFFICHEURS SEPT SEGMENTS et MAX7219 ***********************
  ...
  Bute du programme:
  Réaliser un afficheur numérique sur chaque digit
...
void setup() {
  ...
  Trsf7219(0x09, 0xFF);//0x09 Registre du mode "B" de décodage  est désactivé car paramèttré à 0x00.
  ...
  Trsf7219(0x01, 0x01); // 0x01 Registre du digit 1 paramettre 0x01
  Trsf7219(0x02, 0x02); // 0x02 Registre du digit 2 paramettre 0x02
  Trsf7219(0x03, 0x03); // 0x03 Registre du digit 3 paramettre 0x03
  Trsf7219(0x04, 0x04); // 0x04 Registre du digit 4 paramettre 0x04
  Trsf7219(0x05, 0x05); // 0x05 Registre du digit 5 paramettre 0x05
  Trsf7219(0x06, 0x06); // 0x06 Registre du digit 6 paramettre 0x06
  Trsf7219(0x07, 0x07); // 0x07 Registre du digit 7 paramettre 0x07
  Trsf7219(0x08, 0x08); // 0x08 Registre du digit 8 paramettre 0x08
  delay(1000);
