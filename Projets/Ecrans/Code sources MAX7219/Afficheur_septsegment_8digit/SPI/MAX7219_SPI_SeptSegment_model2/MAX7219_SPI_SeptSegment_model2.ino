...
void setup() {
  ...
  Trsf7219(0x01, 0x00); // 0x01 Registre du digit 1 paramettre Blank soit 0x00 
  Trsf7219(0x02, 0x00); // 0x02 Registre du digit 2 paramettre Blank soit 0x0O
  Trsf7219(0x03, 0x00); // 0x03 Registre du digit 3 paramettre Blank soit 0x00
  Trsf7219(0x04, 0x00); // 0x04 Registre du digit 4 paramettre Blank soit 0x00
  Trsf7219(0x05, 0x00); // 0x05 Registre du digit 5 paramettre Blank soit 0x00
  Trsf7219(0x06, 0x00); // 0x06 Registre du digit 6 paramettre Blank soit 0x00
  Trsf7219(0x07, 0x00); // 0x07 Registre du digit 7 paramettre Blank soit 0x00
  Trsf7219(0x08, 0x00); // 0x08 Registre du digit 8 paramettre Blank soit 0x00
  delay(1000);
