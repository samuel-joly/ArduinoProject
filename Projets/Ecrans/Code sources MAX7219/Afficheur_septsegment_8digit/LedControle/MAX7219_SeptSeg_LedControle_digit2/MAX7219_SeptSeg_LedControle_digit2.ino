...
septSegMax.setRow(0,7,0x77); //A
septSegMax.setRow(0,6,0x05); //r
septSegMax.setRow(0,5,0x3D); //d
septSegMax.setRow(0,4,0x1C); //u
septSegMax.setRow(0,3,0x10); //i
septSegMax.setRow(0,2,0x15); //n
septSegMax.setRow(0,1,0x1D); //o
septSegMax.setRow(0,0,0x00); //blank
delay (4000);
