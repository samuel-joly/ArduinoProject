...
void setup() {
  ...
  Trsf7219(0x0B, 0x03);//0x0B Registre du mode de Scan-limite ( Nombres de digite affichées) parmètre 8 digit soit 0x07
  ...
  Trsf7219(0x01, 0x00); // 0x01 Registre du digit 1 paramètre Blank soit 0x00 no decode mode
  Trsf7219(0x02, 0x00); // 0x02 Registre du digit 2 paramètre Blank soit 0x00 no decode mode
  Trsf7219(0x03, 0x00); // 0x03 Registre du digit 3 paramètre Blank soit 0x00 no decode mode
  Trsf7219(0x04, 0x00); // 0x04 Registre du digit 4 paramètre Blank soit 0x00 no decode mode
...
void loop() {
  ...
  Trsf7219(0x04, 0x00); // blank
  Trsf7219(0x03, 0x5B); // S
  Trsf7219(0x02, 0x4F); // E
  Trsf7219(0x01, 0x0E); // L
  delay (2000);
