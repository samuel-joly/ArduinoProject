...
void setup() {
  ...
  Trsf7219(0x01, 0x7E); // 0x01 Registre du digit 1 paramettre 0xFF (colonne 1) 
  Trsf7219(0x02, 0x81); // 0x02 Registre du digit 2 paramettre 0xFF (colonne 2)
  Trsf7219(0x03, 0xA9); // 0x03 Registre du digit 3 paramettre 0xC3 (colonne 3)
  Trsf7219(0x04, 0x85); // 0x04 Registre du digit 4 paramettre 0xDB (colonne 4)
  Trsf7219(0x05, 0x85); // 0x05 Registre du digit 5 paramettre 0xDB (colonne 5)
  Trsf7219(0x06, 0xA9); // 0x06 Registre du digit 6 paramettre 0xC3 (colonne 6)
  Trsf7219(0x07, 0x81); // 0x07 Registre du digit 7 paramettre 0xFF (colonne 7)
  Trsf7219(0x08, 0x7E); // 0x08 Registre du digit 8 paramettre 0xFF (colonne 8)
  delay(1000);
